...
if  __name__ == '__main__':
    ...
    input_file = os.path.dirname(os.path.abspath(__name__)) + '/natural_language_processing/Dataset/data_topic_modeling.txt'
    # Load data
    ...
    # Generate the LDA(latent Dirichlet allocation) model based on the corpus we just created
    num_topics = 2
    num_words = 4
