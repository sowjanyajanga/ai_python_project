...
# Program execution
# Download Caltech256 images from https://data.caltech.edu/records/nyy15-4j048 to training_images directory
#  python build_features.py --data-folder computer_vision/image_content_analysis/training_images --codebook-file codebook.pkl --feature-map-file feature_map.pkl
...
class FeatureBuilder(object):
    ...
    def get_codewords(self, input_map, scaling_size, max_samples=12):
        ...
        for item in input_map:
            ...
            if count == max_samples:
                print
                "Built centroids for", item['object_class']
...
def get_feature_map(input_map, kmeans, centroids, scaling_size):
    ...
    for item in input_map:
        ...
        print
        "Extracting features for", item['image_path']
        img = cv2.imread(item['image_path'])
        img = resize_image(img, scaling_size)
