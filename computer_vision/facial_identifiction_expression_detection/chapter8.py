...
class FacialExpressionRecognizerLayout(BaseLayout):
    def __init__(self, *args,
        ...
        self.face_detector = FaceDetector(
            ...
            face_cascade='computer_vision/facial_identifiction_expression_detection/params/haarcascade_frontalface_default.xml',
            eye_cascade='computer_vision/facial_identifiction_expression_detection/params/haarcascade_eye_tree_eyeglasses.xml')
...
class DataCollectorLayout(BaseLayout):
    ...
    def __init__(self, *args,
                 ...
                 training_data='computer_vision/facial_identifiction_expression_detection/data/cropped_faces.csv',
                 **kwargs):
        super().__init__(*args, **kwargs)
        self.face_detector = FaceDetector(
            # face_cascade='params/haarcascade_frontalface_default.xml',
            # eye_cascade='params/haarcascade_lefteye_2splits.xml')
            face_cascade='computer_vision/facial_identifiction_expression_detection/params/haarcascade_frontalface_default.xml',
            # eye_cascade='computer_vision/facial_identifiction_expression_detection/params/haarcascade_lefteye_2splits.xml')
            eye_cascade='/Users/sowjanyaj/Documents/Study/AI_MachineLearning/AI_Python_WS/ai_python_project/computer_vision/facial_identifiction_expression_detection/params/haarcascade_eye_tree_eyeglasses.xml')
